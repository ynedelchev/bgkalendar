...
$PHP_HOME = dirname(dirname(dirname(dirname(__DIR__))));
...
function get() {
  ...
  $path = dirname(dirname($path)).'/calendars/'.basename(__DIR__);
  ...
  foreach ($calendarPeriods as $calendarPeriod) {
    array_push($periods, 
       array(
          ...
          'index' => $calendarPeriod->getNumber(),
  ...
  $result = array(
    ...
    'periodsNote'    => 'All indexes in periods are zero based.',
    'periods' => $periods,
    'gregorianEquivalent' => 
           array(
