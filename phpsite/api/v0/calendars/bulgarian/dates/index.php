...
function get() {
  ...
  $calendars['yyyy-mm-dd'] = array(
     ...
     'description' => 'Gives you information about a specific date in the Old Bulgarian Calendar. Here yyyy would specify the year (positive number of arbitrary lentght), mm is the month (1-12) and dd is the day (1-31). Example: 7523-09-20.'
  );
  ...
  $calendars['dddddddddd'] = array(
     ...
     'description' => 'Gives you information about a specific date in the Old Bulgarian Calendar. Here dddddddddd is a positive integer number of arbitrary length. Specifies the number of days elapsed from the absolute beginning of the calendar.'
  );
