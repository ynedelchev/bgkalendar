...
<div style="margin: 2em; align: auto;">
  <?php if ($lang == 'bg') : ?>
    ...
    В кръговият календар за водеща година е избрана Древната Българска Година и затова кръговият циферблат е разделен на 365 равни части. Очевидно нанасяйки срещу всеки ден от Българската година, съответния ден от григорианската - един ден от григорианската година ще остане ненанесен. 
