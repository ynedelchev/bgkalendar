...
<div style="margin: 2em; align: auto;">
  <?php if ($lang == 'bg') : ?>
    Дизайнът на календара включва кръгов календар, при който като на циферблат са нанесени 365<sup>-те</sup> дни на годината, като от външната страна са поставени дните по месеци на Грегорианския календар, а от вътрешната дните по месеците на Древния Български Календар. Така много лесно може да се види кой ден на кой съответства.
    <br/><br/>
    ...
    Както знаем грегорианската 2020<sup>-та</sup> година е високосна (защото се дели на 4 без остатък и не се дели на 100). Това означава, че имаме ден 29-ти Февруари и цялата година се състои от 366 дена.<br/>
    ...
    В кръговият календар за водеща година е избрана Древната Българска Година и затова кръговият циферблат е разделен на 365 равни части. Очевидно нанасяйки срещу всеки ден от Българската година, съответния ден от грегорианската - един ден от грегорианската година ще остане ненанесен. 
    ...
    Също 31<sup>-ви</sup> ден от Дванайсти Месец (Алтом) (Този ден се нарича още Ени), съответства на 21<sup>-ви</sup> Декември 2020 година.<br/>
    ...
    Тоест поради това че Древната Българска Година започва с 10 дена по-рано от Грегорианската, се получава така, че вземайки Българската година за водеща, ние трябва да изобразим 10 дена от предходната грегорианска година (23<sup>-ти</sup> - 31<sup>-ви</sup> Декември 2019), а последните дни на текущата липсват (22<sup>-ри</sup> - 31<sup>-ви</sup> Декември 2020).
    Тази липса естествено се компенсира от табличната версия на календара изобразена в долната част, където са изцяло изобразени 2020 грегорианска година (включително и дните от 22<sup>-ри</sup> до 31<sup>-ви</sup> Декември) и съответната ѝ 7525 Древна Българска Година.
    <br><br/>
